...
using Mustache.CartService.Documentation.Installers;
using Mustache.CartService.WebApi.Handlers;
using Mustache.CartService.WebApi.Hypermedia;
using Mustache.CartService.WebApi.Infrastructure.Installers;
using Mustache.CartService.Model;
using IQ.Platform.Framework.WebApi.Infrastructure;

namespace Mustache.CartService.WebApi.Infrastructure
{
	...
	public class DefaultApiContainer : ApiContainer
	{
		...
		{
			return
				_windsorContainer.Resolve<ApiSecurityContextProvidingHandler<CartServiceApiUser, NullUserContext>>();
		}
